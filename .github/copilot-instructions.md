# Copilot Instructions — `goalkeeper`
...
- **Authoritative path**: `/home/ssf/Documents/Github/goalkeeper` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/goalkeeper.git`, branch `main`.
